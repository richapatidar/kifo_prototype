function kiteset(x1, y1, x2, y2, x3, y3) {
  ...
  this.show = function() {
    ...
    this.kiteWater = function() {
      ...
      this.Kite1.kone(parseFloat(fName.getString(1)*10));
      this.Kite2.ktwo(parseFloat(fName.getString(2)*10));
      this.Kite3.kthree(parseFloat(fName.getString(3)*10));
      this.Kite4.kfour(parseFloat(fName.getString(4)*10));
    ...
    this.kiteGreen = function() {
      ...
      // translate(630, 10);
      // rotate(PI / 2);
      this.Kite5.kone(parseFloat(fName.getString(5)));
      this.Kite6.ktwo(parseFloat(fName.getString(6)));
      this.Kite7.kthree(parseFloat(fName.getString(7)));
      this.Kite8.kfour(parseFloat(fName.getString(8)));     
    }
...
//       translate(630, 10);
//       rotate(radians(PI/2));
      this.Kite9.kone(parseFloat(fName.getString(9)));
      this.Kite10.ktwo(parseFloat(fName.getString(10)));
      this.Kite11.kthree(parseFloat(fName.getString(11)));
      this.Kite12.kfour(parseFloat(fName.getString(12)));
    }
